...
verdi computer configure sshtowin --config computer_ddm07162_config.yaml ddm07162

verdi computer setup --config computer_localhost.yml
verdi computer configure local --config computer_localhost_config.yaml localhost
