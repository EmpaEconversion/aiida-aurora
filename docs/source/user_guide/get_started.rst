...
Then use ``verdi code setup`` with the ``aurora`` input plugin
to set up an AiiDA code for aiida-aurora.
...
If you have already set up your own aiida_aurora code using
