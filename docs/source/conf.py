# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-aurora
#
...
release = aiida_aurora.__version__
...
html_use_opensearch = 'http://aiida-aurora.readthedocs.io'
...
htmlhelp_basename = 'aiida-aurora-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_aurora')
