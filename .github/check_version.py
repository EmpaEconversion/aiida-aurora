...
Check version number in setup.json and aiida_aurora/__init__.py and make sure
they match.
"""
...
import aiida_aurora  # pylint: disable=wrong-import-position
VERSION = aiida_aurora.__version__

if VERSION != setup_content['version']:
    print('Version number mismatch detected:')
    print("Version number in '{}': {}".format(SETUP_FNAME, setup_content['version']))
    print("Version number in '{}/__init__.py': {}".format('aiida_aurora', VERSION))
    sys.exit(1)
